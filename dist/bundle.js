...
/* harmony export */ });
/* harmony import */ var _Project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Project.js */ "./src/classes/Project.js");
...
class Collection {
  ...
  constructor() {
    this.projects = [];
    this.projects.push(new _Project_js__WEBPACK_IMPORTED_MODULE_0__.default("Daily", ""));
    this.projects.push(new _Project_js__WEBPACK_IMPORTED_MODULE_0__.default("Weekly", ""));
    this.projects.push(new _Project_js__WEBPACK_IMPORTED_MODULE_0__.default("Monthly", ""));
    this.projects.push(new _Project_js__WEBPACK_IMPORTED_MODULE_0__.default("Yearly", ""));
  }
...
class Auth {
  ...
  static initAuth(){
    ...
    headerAuthBtn.addEventListener("click", () => {
      _UI__WEBPACK_IMPORTED_MODULE_0__.default.removePopups();
...
/* harmony export */ });
/* harmony import */ var _classes_Collection_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../classes/Collection.js */ "./src/classes/Collection.js");
...
/* harmony import */ var _classes_Task_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../classes/Task.js */ "./src/classes/Task.js");
...
class DB {
  ...
  static initCollection(usr){
    ...
    db.doc(userEmail).get().then((doc)=>{
      if (!doc.exists) {
        const string = JSON.stringify(new _classes_Collection_js__WEBPACK_IMPORTED_MODULE_0__.default());
  ...
  static addProject(pName, pDate){
    ...
    if(!isDuplicate){
      DB.getMyData().then(result=>{
        ...
        const newProj = new _classes_Project_js__WEBPACK_IMPORTED_MODULE_1__.default(pName, pDate);
  ...
  static addTask(string, pName){
    DB.getMyData().then(result=>{
      ...
      myProjArray.forEach(proj=>{
        if (proj.name === pName){
          const newTask = new _classes_Task_js__WEBPACK_IMPORTED_MODULE_2__.default(string);
  ...
  static editProj(pName, newName, newDate){
    DB.getMyData().then(result=>{
      ...
      DB.saveMyData(myData).then(()=>{
        _UI_js__WEBPACK_IMPORTED_MODULE_3__.default.loadProjectBtns(); 
      })
    })
  }
  ...
  static editTask(pName, taskIndex, newTask){
    DB.getMyData().then(result=>{
      ...
      myData.projects = myProjArray;
      DB.saveMyData(myData).then(()=>{
        _UI_js__WEBPACK_IMPORTED_MODULE_3__.default.loadProjectTasks(pName);  // reload
      })
    })
  }
  ...
  static deleteProj(pName){
    DB.getMyData().then(result=>{
      ...
      myData.projects = myProjArray;
      DB.saveMyData(myData).then(()=>{
        _UI_js__WEBPACK_IMPORTED_MODULE_3__.default.loadProjectBtns();  // reload
      })
    })
  }
 ...
 ***************************************************************************************/
  static initProjCreator(){
    ...
    projCreatorForm.addEventListener("submit", (e)=>{
      ...
      if(pName){
        _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.addProject(pName, pDate);
  ...
  static initTaskCreator(){
    ...
    taskCreatorForm.addEventListener("submit", (e)=>{
      ...
      if(string){
        _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.addTask(string, pName);
  ...
  static initProjEditor(){
    projEditorForm.addEventListener("submit", (e)=>{
      ...
      if(newName){
        _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.editProj(pName, newName, newDate);
        UI.removePopups();  
      }else{
    ...
    projEditorDeleteBtn.addEventListener("click", (e)=>{
      e.preventDefault();
      const pName = projEditorForm.getAttribute("data-pName");
      _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.deleteProj(pName);
  ...
  static initTaskEditor(){
    taskEditorForm.addEventListener("submit", (e)=>{
      ...
      if(newTask){ 
        _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.editTask(pName, taskIndex, newTask);
        UI.removePopups();
      }else{
    ...
    taskEditorDeleteBtn.addEventListener("click", (e)=>{
      ...
      const pName = taskEditorWindow.getAttribute("data-pName");
      const taskIndex = taskEditorWindow.getAttribute("data-taskIndex");
      _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.deleteTask(pName, taskIndex);
      UI.removePopups();
    })
...
static loadProjectBtns(){
    _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.getMyData().then(result=>{
...
static insertTask(string, done, pName, tIndex){ 
  ...
  checkbox.addEventListener("click", (e)=>{
    if(done){
      ...
      taskText.style.textDecoration = "";
      _DB_js__WEBPACK_IMPORTED_MODULE_0__.default.toggleTaskDoneStatus(pName, tIndex);
    }else{
      done = true;
 ...
 ***************************************************************************************/
  ...
  static formatDate(date){
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(year, month, day), 'yyyy/MMM/dd');
  }
...
document.addEventListener('DOMContentLoaded', ()=>{
  _modules_Auth_js__WEBPACK_IMPORTED_MODULE_0__.default.initAuth(); 
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initProjCreator();
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initTaskCreator();
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initProjEditor();
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initTaskEditor(); 
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initPopupCloser();
  _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.initRoutineProjBtns();
})

firebase.auth().onAuthStateChanged(usr=>{
  if (usr){
    _modules_DB_js__WEBPACK_IMPORTED_MODULE_2__.default.initCollection(usr);
    _modules_Auth_js__WEBPACK_IMPORTED_MODULE_0__.default.loadAuthData(usr);  
    _modules_Auth_js__WEBPACK_IMPORTED_MODULE_0__.default.hideLoginWindow();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.loadAdders();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.loadProjectBtns();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.loadProjectTasks("Daily");
  }else{
    _modules_Auth_js__WEBPACK_IMPORTED_MODULE_0__.default.showLoginWindow();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.unLoadAdders();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.unLoadProjectBtns();
    _modules_UI_js__WEBPACK_IMPORTED_MODULE_1__.default.unLoadProjectTasks();
  }
})
